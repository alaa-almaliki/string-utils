...
class Email extends AbstractString
{
    /**
     * @var array $pattern
     * copied from source  - modified string to an array because it is very long line
     * @see http://stackoverflow.com/a/40523418/3502446
     */
    static private $emailPattern = [
    ...
    public function isValid()
    {
        ...
        return $valid
            && $this->_checkDns()
            && $this->_regex(implode(self::$emailPattern));
    }

    /**
     * @return string
     */
    protected function _getEmailDomain()
    {
        return array_pop(explode('@', $this->getValue()));
    }
    ...
    {
        return checkdnsrr($this->_getEmailDomain());
    }
}